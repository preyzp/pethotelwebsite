	...
	<div class="row justify-content-center">
		<div class="col-md-12">
			<div class="card">
				...
				{!! Form::close() !!}
				<div class="card-body">
					<a href="{{ url('adminph/kandang/tambah') }}" class="btn btn-primary btn-xs mb-2">Tambah</a>
					<table class="table table-hover table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ url('adminph/kandang/edit/'.$row->id) }}" class="btn btn-info" > Ubah</a>
									&nbsp;
									<a href="{{ url('adminph/kandang/hapus/'.$row->id) }}" class="btn btn-danger"
