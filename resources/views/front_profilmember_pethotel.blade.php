	...
	<div class="row justify-content-center">
		<div class="col-md-10">
			<div class="card">
				...
				<div class="card-body">
					<a href="{{ url('member/profil/edit/'.Auth::guard('member')->user()->id) }}" class="btn btn-danger btn-xs mb-2"> Ubah </a>	
					<a href="{{ url('caripethotel/hasil-cari') }}" class="btn btn-primary btn-xs mb-2"> Tambah Booking </a>	
					<a href="{{ url('member/booking/member') }}" class="btn btn-primary btn-xs mb-2"> Data Booking </a>	
					
                    <table class="table table-hover table-striped table-bordered">
						<thead>
							<tr>
								<td width="20%" align="left">Nama Member</td>
								<td><b>{{Auth::guard('member')->user()->nama }}</b></td>	
							</tr>
							<tr>
                            ...
                            <tr>
								<td width="20%" align="left">No Hp </td>
								<td><b>{{Auth::guard('member')->user()->no_hp }}</b></td>
							</tr>
