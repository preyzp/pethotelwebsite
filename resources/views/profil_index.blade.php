		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav">Home<span class="lnr lnr-arrow-right"></span>Profile</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 home-about-right no-padding">
					...
					<h5>Call Center 08280107534</h5>
					<p>
						PetHotel.com merupakan sebuah website yang memberikan informasi mengenai Pet Shop yang menyediakan jasa Pet Hotel di daerah Jambi.
					</p>
				</div>
			</div>
		</div>
