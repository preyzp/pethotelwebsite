            ...
            <div class="card">
                ...
                {{ Form::model($pethotel, array('action' => $action, 'files' => true, 'method' => $method)) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('nama_pemilik',null,array('class'=>'form-control','placeholder' => 'Nama Pemilik','autofocus')) }}
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        {{ Form::label('foto2', 'Foto Pet Hotel 2') }}
                        {!! Form::file('foto2', ['class' => 'form-control']) !!}
                        <span class="text-danger">{{ $errors->first('foto2') }}</span>
                    </div>
                    <div class="form-group">
                        {{ Form::label('kategori_pethotel', 'Kategori') }}
                        {!! Form::select('kategori_pethotel',
                            ['Pet Hotel Anjing' => 'Pet Hotel Anjing',
                            'Pet Hotel Kucing' => 'Pet Hotel Kucing',
                            'Pet Hotel Anjing&Kucing' => 'Pet Hotel Anjing&Kucing'], 
