			...
			<div class="card">
				...
				<div class="input-group custom-search-form">
					...
					<span class="input-group-btn">
						...
						<a href="{{ url('admin2/pethotel') }}" class="btn btn-primary"> Refresh Data </a>
					</span>
				</div>
				{!! Form::close() !!}
				<div class="card-body">
					<a href="{{ url('admin2/pethotel/tambah') }}" class="btn btn-primary btn-xs mb-2">Tambah</a>
					<table class="table table-hover table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ url('admin2/pethotel/edit/'.$row->id) }}" class="btn btn-info" > Ubah</a>
									&nbsp;
									<a href="{{ url('admin2/pethotel/hapus/'.$row->id) }}" class="btn btn-danger"
