				...
				<div class="row align-items-center justify-content-between d-flex">
					...
					<nav id="nav-menu-container">
						<ul class="nav-menu">
				          ...
				          @else
                           <li class="nav-item">
								<a class="nav-link active" href="{{ url('member/dashboard') }}">Home</a>
							</li>
							<li class="nav-item">
								<a class="nav-link active" href="{{ url('/profil') }}">Profil Website</a>
							</li>
			...
			<div class="container">
				...
				<div class="row fullscreen d-flex align-items-center justify-content-start">
					<div class="banner-content col-lg-8 col-md-12">
						<h1 class="text-uppercase bg-black" >
						PetHotel.com
						</h1>
						<a href="{{ url('caripethotel/hasil-cari') }}" class="primary-btn header-btn text-uppercase">Temukan PetHotel</a>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row d-flex justify-content-center">
					<div class="menu-content pb-60 col-lg-8">
						<div class="title text-center">
							<h1 class="mb-10">Proses Booking Pet Hotel</h1>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="single-process">
							...
							<p>
								Carilah Pet Hotel yang sesuai dengan yang anda inginkan dan sesuai dengan kebutuhan hewan peliharaan anda
							</p>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="single-process">
							...
							<p>
								Setelah anda menemukan Pet Hotel yang anda inginkan, pilih Pet Hotel yang ingin anda booking
							</p>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="single-process">
							...
							<p>
								Isi data booking pada form booking sesuai dengan data diri anda, sebelum melakukan booking pastikan anda sudah daftar dan menjadi member
							</p>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="single-process">
							...
							<p>
								Silahkan melakukan pembayaran pada Pet Hotel yang anda pilih apabila anda sudah melakukan booking
							</p>
						</div>
					</div>
				</div>
